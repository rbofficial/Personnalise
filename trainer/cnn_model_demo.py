...
# classes are basically topics, words i suppose are tokens?
def generate_cnn_model(n_classes, n_words):
    """2 layer ConvNet to predict from sequence of words to a class."""

    def cnn_model(features, target):  # what are features and targets?
        ...
        with tf.variable_scope('CNN_layer1'):  # creates layers
